...
class Interfaz(cTk.CTk):
    """Interfaz grafica para descargar videos y playlists de Youtube.
        ...
        Metodos:
            ...
            boton_descarga_func(): Crea un boton, le vinculamos la funcion de descarga y cambiamos el tamañó de pantalla.
    ...
    def crear_elementos(self):
        ...
        """
        cTk.CTkLabel(self, text="YTcyDLoad", 
        ...
        self.boton_video = cTk.CTkButton(self, 
                                        text="Video",
                                        text_color= ("black"), 
                                        font=cTk.CTkFont(weight="bold"),
                                        width=100, 
                                        height=25, 
                                        command=self.evento_boton_video).place(x=96, y=120)
        self.boton_playlist = cTk.CTkButton(self, 
                                            text="Playlist", 
                                            text_color= ("black"), 
                                            font=cTk.CTkFont(weight="bold"), 
                                            width=100, 
                                            height=25, 
                                            command=self.evento_boton_playlist).place(x=212, y=120)
    ...
    def crear_botones_inferiores(self):
        ...
        self.boton_video = cTk.CTkButton(self, 
                                        ...
                                        width=100, 
                                        height=25, 
                                        command=self.evento_video_formato).place(x=96, y=180)
        self.boton_mp3 = cTk.CTkButton(self,
                                        text="MP3",
                                        text_color= ("black"), 
                                        font=cTk.CTkFont(weight="bold"), 
                                        width=100, 
                                        height=25, 
                                        command=self.evento_mp3_formato).place(x=212, y=180)
    ...
    def boton_descarga_func(self):
        ...
        self.boton_descarga = cTk.CTkButton(self, 
                                            text="Descarga", 
                                            text_color= ("black"), 
                                            font=cTk.CTkFont(weight="bold"), 
                                            command=self.evento_boton_descarga).place(x=137, y=240)
